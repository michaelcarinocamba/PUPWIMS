...
<img src="../images/pupmainlogo.png" style = "width: 130px; float:left; margin-right: 5px;">
        ...
        <br><hr>
         ...
         <div class="modal fade" id="filterModal" tabindex="-1" role="dialog" aria-labelledby="filterModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    ...
                    <form action = "Adviser_Print.php?Filter" method = "POST">
                        <div class = 'form-row'>
        ...
        <table id = "company">
            ...
            <footer style = "margin-left: 20px;">
                ...
                <i><p style = "margin: 0; margin-left: 2%; font-size: 4;">(Signature over Printed Name)</p></i>
                <p style = "margin: 5px; margin-left: 10%;">Prepared By:</p>
            </footer>
