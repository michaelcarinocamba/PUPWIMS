...
{
    $emailTo = $_POST['email'];
    $checkemail = mysqli_query($conn, "SELECT * FROM coordinator_info WHERE email = '$emailTo'");
    if(mysqli_num_rows($checkemail) === 1)
    {
            $code = uniqid(true);
            $query = mysqli_query($conn, "INSERT INTO coordinator_reset(code, email) VALUES('$code' , '$emailTo')");
            if(!$query)
            {
                exit("Error");
            }
        ...
        try {
            ...
            //Content
            $url = "http://" . $_SERVER["HTTP_HOST"] . dirname($_SERVER["PHP_SELF"]) . "/Coordinator.php?code=$code";
    ...
    else
    {
        ...
        header ("Location: Coordinator.php?change&error=$error");
        exit();
    }
}
...
if(isset($_REQUEST['code']))
{
    ...
    $getEmailQuery = mysqli_query($conn, "SELECT email FROM coordinator_reset WHERE code='$code'");
    ...
    if(isset($_POST["password"]))
    {
        ...
        $query = mysqli_query($conn, "UPDATE coordinator_info SET password='$pw' WHERE email='$email'");
        if($query)
        {
            $query = mysqli_query($conn, "DELETE FROM coordinator_reset WHERE code='$code'");
        }
        else{
        ...
        echo "<script> location.href='Coordinator.php?successpassword'; </script>";
            exit;
        ...
        <section>
            ...
            <div class = "Content">
                ...
                <div class = "input">
                    ...
                    <p>Go back to <a href="../Coordinator/Coordinator_Login.php">Sign in</a><br><br></p>
        ...
        <body>
            <section>
                ...
                <div class = "Content">
                    ...
                    <form action="../Coordinator/Coordinator_Login.php" method="post">
