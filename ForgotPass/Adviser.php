...
{
    $emailTo = $_POST['email'];
    $checkemail = mysqli_query($conn, "SELECT * FROM adviser_info WHERE email = '$emailTo'");
    if(mysqli_num_rows($checkemail) === 1)
    {
        $code = uniqid(true);
        $query = mysqli_query($conn, "INSERT INTO adviser_reset(code, email) VALUES('$code' , '$emailTo')");
        if(!$query)
        {
            exit("Error");
        }
        ...
        try {
            ...
            //Content
            $url = "http://" . $_SERVER["HTTP_HOST"] . dirname($_SERVER["PHP_SELF"]) . "/Adviser.php?code=$code";
    ...
    else
    {
        ...
        header ("Location: Adviser.php?change&error=$error");
        exit();
    }
}
...
if(isset($_REQUEST['code']))
{
    ...
    $getEmailQuery = mysqli_query($conn, "SELECT email FROM adviser_reset WHERE code='$uniqcode'");
    ...
    if(isset($_POST["password"]))
    {
        ...
        $query = mysqli_query($conn, "UPDATE adviser_info SET password='$pw' WHERE email='$email'");
        if($query)
        {
            $query = mysqli_query($conn, "DELETE FROM adviser_reset WHERE code='$uniqcode'");
        }
        else{
        ...
        echo "<script> location.href='Adviser.php?successpassword'; </script>";
            exit;
    ...
    <body>
        <section>
            ...
            <div class = "Content">
                <div class = "form" >
                    <center>
                <img alt="PUP" class="img-circle" src="../pupsjlogo.png"><br>
                ...
                <div class = "input">
                    ...
                    <p>Go back to <a href="../Student/StudentLogin.php">Sign in</a><br><br></p>
        ...
        <body>
            <section>
                ...
                <div class = "Content">
                    ...
                    <form action="../Adviser/Adviser_Login.php" method="post">
    ...
    <section>
        ...
        <div class = "Content">
            ...
            <div class = "input">
                ...
                <p>Go back to <a href="../Adviser/Adviser_Login.php">Sign in</a><br><br></p>
                <h6> By using this service, you understood and agree to the PUP Online Services <a href="https://www.pup.edu.ph/terms/" target="_blank">Terms of Use</a> and <a href="https://www.pup.edu.ph/privacy/" target="_blank"> Privacy Statement</a></h6>
                </center>
            </div>
            </form>
